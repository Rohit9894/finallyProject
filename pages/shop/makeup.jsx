...
export default function MakeupProducts() {
  ...
  const getData = async (min, max) => {
    ...
    const { data } = await axios.get(
      `http://localhost:3000/api/makeup?min=${min}&max=${max}`
    );
    console.log(data);
  ...
  return (
    ...
    >
      ...
      <Flex gap={"48px"}>
                  ...
                  <AccordionItem>
                    ...
                    <AccordionPanel pb={4} lineHeight={"2"}>
                      <Checkbox
                        ...
                        value="Under $25"
                        onChange={(e) =>
                          handleCheckbox(0, 25, e.target.checked)
                        }
                      >
                        Under $25
                      </Checkbox>
                      ...
                      <Checkbox
                        colorScheme={"gray"}
                        onChange={(e) =>
                          handleCheckbox(25, 50, e.target.checked)
                        }
                      >
                        $25 to $50
                      </Checkbox>
        ...
        <Box
          width={{ base: "95%", sm: "95%", md: "80%", lg: "80%" }}
          margin={"auto"}
        >
          <Box m={"0px 0px 32px"}>
            <Image
